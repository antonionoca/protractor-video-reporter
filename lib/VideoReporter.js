...
VideoReporter.prototype.reportSpecStarting = function(result) {
  VideoReporter.prototype.specStarted(result);
};
...
VideoReporter.prototype.reportSpecResults = function(result) {
  if (result.results_.failedCount === 0) {
    result.status = 'passed';
  } else {
    result.status = 'failed';
  }

  VideoReporter.prototype.specDone(result);
};
